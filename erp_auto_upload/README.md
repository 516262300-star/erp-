...
├─ 无logo主图/ *.jpg *.png   （也支持：主图无logo/、无logo图/、无 logo 图/、原图/、主图/无logo/）
├─ 详情页/   *.jpg *.png
├─ 尺寸图/   *.jpg *.png
└─ 视频/     *.mp4
```
...
- `无logo主图`、`主图无logo`、`无logo图`、`无 logo 图`、`原图`，以及 `主图/无logo`、`主图/无 logo`、`主图/无logo图`、`主图/无 logo 图`、`主图/原图` 都支持，里面的图片会上传到 ERP 的“主图原图”。
- `详情页` 按文件名自然排序上传。
